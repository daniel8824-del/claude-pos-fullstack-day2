...
**Day 2 — 풀스택 5단계 + POS 상권분석** · 강의 사전 배포 사이트

라이브: <https://daniel8824-del.github.io/claude-pos-fullstack-day2/>
...
- hyperframes 도입 영상 2개 (60초 × 2 — 5차시 하네스 / 7차시 QMD)
...
- **분량**: 270분 (4.5시간) — 회사 협의로 30분 연장
- **청중**: 비개발자 5인 + 개발자 (AI 지식 편차 있음)
- **핵심 톤**: eli5 + 만화 + 실습 우선
